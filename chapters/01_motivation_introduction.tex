...
In this thesis I am mainly introducing GraphiniusJS and it's underlying design principles, but 

 , a WebGL / Three.js based graph visualization library using low-level datastructures and concepts, enabling it to visualize up to 20k nodes / 60k edges fluenlty even on middle-class laptops. We will also provide an outlook on the whole, emerging Graphinius platform and it's exciting capabilities.


\section{The history of OGMA}
...
no automatic coupling with existing test data corporae 
