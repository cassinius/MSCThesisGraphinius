...
\begin{figure}[H]
	% \centering
	\hspace*{-1.5cm}
	\includegraphics[width=1.2\textwidth]{figures/Graphinius_Architecture_new}
...
As the name suggests, the Base module offers all the functionality necessary to develop graph-based applications on top of it, including basic graph-computations and algorithms as well as real-time, in-browser visualization. It is therefore logically composed of the two main modules \textit{GraphiniusJS} and \textit{GraphiniusVIS} as well as a mechanism of communication between those two, the \textit{Op-Log}.
...
\label{sect:graphinius_js}
	...
	\label{ssect:graph_core}
		...
		\subsubsection{Core Search - Traversal}
